...
import 'application_calendar.dart';
import 'application_country.dart';
import 'application_currency.dart';

part 'application_dictionary.g.dart';

@JsonSerializable()
class AppDictionaryGet {
  BoondMeta meta;
  AppDictionaryGetData data;
  ...
  factory AppDictionaryGet.fromJson(Map<String, dynamic> json) =>
      _$AppDictionaryGetFromJson(json);

  Map<String, dynamic> toJson() => _$AppDictionaryGetToJson(this);
}

@JsonSerializable()
class AppDictionaryGetData {
  ...
  factory AppDictionaryGetData.fromJson(Map<String, dynamic> json) =>
      _$AppDictionaryGetDataFromJson(json);

  Map<String, dynamic> toJson() => _$AppDictionaryGetDataToJson(this);
}
...
class AppDictDeliveryOrder {
  ...
  AppDictDeliveryOrder({
    required this.id,
    this.value,
    required this.maskSignatureBlock,
    this.insert,
  });
...
class AppDictProject {
  ...
  AppDictProject({
    ...
    this.value,
    required this.mode,
    required this.scheduleProductionTurnover,
