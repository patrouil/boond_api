...
class BoondAuth {
  ...
  /// [traceLevel] is used to enable the API debugging.
...
class _BoondClientTokenAuthClient extends http.BaseClient {
  ...
  _BoondClientTokenAuthClient(
    ...
    if (traceLevel != null) BoondAuth.log.level = traceLevel;
    this._jwtToken =
        this._buildJwtToken(clientToken, userToken, mode, clientKey);
  }
  ...
  Future<http.StreamedResponse> send(http.BaseRequest request) async {
    request.headers['X-Jwt-Client-Boondmanager'] = this._jwtToken;
